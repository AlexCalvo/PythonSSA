...
class AES_CIPHER:
 ...
 def cifrar(self, cadena, IV, block):#Cifra el parámetro cadena (de tipo String) con una IV específica, y devuelve el texto cifrado binario"""
 ...
 def descifrar(self, cifrado, IV, block):
     ...
     decipher_des = AES.new(self.key, AES.MODE_CBC, IV)
